...
## Description
This project consisted of a multi-week ethical analysis of the Boeing 737 MAX crashes, with a particular focus on the Maneuvering Characteristics Augmentation System (MCAS). Using a structured engineering ethics framework, I examined how technical design decisions, organizational pressures, regulatory processes, and communication failures interacted to produce catastrophic outcomes. The analysis progressed from identifying ethical issues and stakeholders, to evaluating missing information and assumptions, clarifying value-laden terms (such as safety, responsibility, and transparency), and ultimately applying ASME ethical canons to reason through conflicts and ethical precedence.
